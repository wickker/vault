...
func (q *Queries) CreateRecord(ctx context.Context, arg CreateRecordParams) (Record, error) {
	row := q.db.QueryRowContext(ctx, createRecord, arg.Name, arg.Value, arg.ItemID)
	var i Record
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) DeleteRecord(ctx context.Context, id int32) (Record, error) {
	row := q.db.QueryRowContext(ctx, deleteRecord, id)
	var i Record
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) DeleteRecords(ctx context.Context, itemID int32) ([]Record, error) {
	rows, err := q.db.QueryContext(ctx, deleteRecords, itemID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) GetRecordUserID(ctx context.Context, id int32) (string, error) {
	row := q.db.QueryRowContext(ctx, getRecordUserID, id)
...
func (q *Queries) ListRecordsByItemId(ctx context.Context, itemID int32) ([]ListRecordsByItemIdRow, error) {
	rows, err := q.db.QueryContext(ctx, listRecordsByItemId, itemID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) UpdateRecord(ctx context.Context, arg UpdateRecordParams) (Record, error) {
	row := q.db.QueryRowContext(ctx, updateRecord, arg.Name, arg.Value, arg.ID)
	var i Record
	err := row.Scan(
		&i.ID,
		&i.Name,
