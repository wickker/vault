...
func (q *Queries) CreateItem(ctx context.Context, arg CreateItemParams) (Item, error) {
	row := q.db.QueryRowContext(ctx, createItem, arg.Name, arg.ClerkUserID, arg.CategoryID)
	var i Item
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) DeleteItem(ctx context.Context, arg DeleteItemParams) (Item, error) {
	row := q.db.QueryRowContext(ctx, deleteItem, arg.ID, arg.ClerkUserID)
	var i Item
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) ListItemsByCategory(ctx context.Context, arg ListItemsByCategoryParams) ([]int32, error) {
	rows, err := q.db.QueryContext(ctx, listItemsByCategory, arg.CategoryID, arg.ClerkUserID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListItemsByUser(ctx context.Context, arg ListItemsByUserParams) ([]ListItemsByUserRow, error) {
	rows, err := q.db.QueryContext(ctx, listItemsByUser,
		arg.ClerkUserID,
		arg.Name,
		arg.CategoryID,
		arg.OrderBy,
