...
func (q *Queries) CreateCategory(ctx context.Context, arg CreateCategoryParams) (Category, error) {
	row := q.db.QueryRowContext(ctx, createCategory, arg.Name, arg.Color, arg.ClerkUserID)
	var i Category
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) DeleteCategory(ctx context.Context, arg DeleteCategoryParams) (Category, error) {
	row := q.db.QueryRowContext(ctx, deleteCategory, arg.ID, arg.ClerkUserID)
	var i Category
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) ListCategoriesByUser(ctx context.Context, clerkUserID string) ([]ListCategoriesByUserRow, error) {
	rows, err := q.db.QueryContext(ctx, listCategoriesByUser, clerkUserID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
